...
def _append_web_assistant_turn(
    ...
    *,
    ...
    if _anthropic_enabled():
        background_extract(user_input, answer, ANTHROPIC_API_KEY)
...
def parse_store_tags(response_text):
    ...
    for match in re.finditer(pattern, response_text):
        ...
        try:
            ...
            logging.info(f'[Self-Store] Stored: {category}/{key} (emotion: {emotion}, weight: {weight})')
        except Exception as e:
